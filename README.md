...
Features considered for future versions: VST plugin,series mode(s), user-defined calibration target dB, optionally more than 4 lanes, prettier interface (other than default xputty), impulse response / convolution, etc...
