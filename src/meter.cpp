...
// should be called once per processed block, after all sample () calls for that block
...
void c_meterwidget::render_base (cairo_t *cr) {
  ...
  const meter_line lines [] = {
    { 0.5f,   0.0, 1.0, 0.0, 0.50 },
    { 0.75f,  1.0, 1.0, 0.0, 0.50 },
    { 0.875f, 1.0, 0.5, 0.0, 0.50 },
    { 1.0f,   1.0, 0.0, 0.0, 0.50 },
  };
